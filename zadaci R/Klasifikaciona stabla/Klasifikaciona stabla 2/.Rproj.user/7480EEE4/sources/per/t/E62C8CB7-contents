...
# u test setu, sto je 2163, tacno predvideli 2033, pa nam je tacnost visoka, 0.94

# precision = udeo onih koje smo predvideli da su pozitivne koje su stvarno pozitivne
# ovde smo od 523 observacija za koje smo rekli da imaju visok broj recenzija
# za 467 predvideli tacno
# a za 56 smo rekli da imaju, a zapravo nemaju, pa nam
# je precision 0.893

# recall = udeo observacija koje su stvarno pozitivne koje smo predvideli da su pozitivne
# ovde smo od ukupno 541 observacije sa visokim brojem recenzija 467 predvideli tacno,
# a za 74 smo rekli da nemaju visok broj recenzija, a zapravo imaju, pa nam 
# je recall nesto manji od precisiona, odnosno 0.863

# F1 = sluzi za evaluaciju modela kada su precision i recall u balansu, 
# govori koliko je dobar model, u nasem slucaju je 0.878, pa mozemo da 
