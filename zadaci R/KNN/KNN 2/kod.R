...
# prosli smo kroz sve elemente dataseta i uzeli indeks observacija
...
# ovde smo od 192 observacije za koje smo rekli da imaju skup smestaj, 
# pogodili 128 da jesu skupi,
